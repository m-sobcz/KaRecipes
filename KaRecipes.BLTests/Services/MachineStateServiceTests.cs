...
namespace KaRecipes.BL.Services.Tests
{
    public class MachineStateServiceTests
    {
        ...
        public void LifeBitServiceTest_NormalOperation_Works()
        {
            ...
            machineStates.Add("KaRecipes.M01.DB_00_Parameters.single1", new MachineStateData() { NodeId = "KaRecipes.M01.DB_00_Parameters.single1" });
            machineStates.Add("KaRecipes.M01.DB_00_Parameters.single2", new MachineStateData() { NodeId = "KaRecipes.M01.DB_00_Parameters.single2" });
            machineStates.Add("KaRecipes.M01.DB_00_Parameters.single3", new MachineStateData() { NodeId = "KaRecipes.M01.DB_00_Parameters.single3" });
            ...
            mockDbDataAccess.Verify(x => x.Write(It.IsAny<MachineStateData>()),Times.Exactly(3));
        }
        [Fact()]
